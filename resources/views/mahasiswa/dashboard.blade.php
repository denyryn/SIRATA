                        ...
                        <tr>
                            ...
                            <td class="flex flex-row items-center justify-center">
                                @if (str_contains(strtolower($surat->status_terbaru), 'disetujui'))
                                    <a href="{{ route('mahasiswa.surat.stream', $surat->id_surat) }}"
                                ...
                                @else
                                    <a href="{{ route('mahasiswa.surat.preview', $surat->id_surat) }}"
                                ...
                                @endif
                                <a href="{{ route('mahasiswa.surat.lacak', $surat->id_surat) }}"
                                    class="p-2 px-4 text-center text-white duration-150 bg-blue-600 rounded-lg btn animate-none hover:bg-blue-700"
                                    title="Lacak Surat">
                                    <span class="text-white size-5">
                                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
