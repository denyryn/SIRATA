...
<div id="ubah-profil-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" method="POST" action="{{ route('mahasiswa.profile.update') }}"
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nim" id="nim"
                            ...
                            placeholder="Ketik NIM" required value="{{ $data_mahasiswa->nim }}" disabled>
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nama_mahasiswa" id="nama_mahasiswa"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Ketik Nama Mahasiswa" required value="{{ $data_mahasiswa->nama_mahasiswa }}"
                            disabled>
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="id_dosen_pembimbing" id="dosen_wali"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Pilih Dosen Pembimbing" required
                            value="{{ $data_mahasiswa->dosen->nama_dosen }}" disabled>
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="id_program_studi" id="id_program_studi"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Ketik NIM" required value="{{ $data_mahasiswa->program_studi->nama_prodi }}"
                            disabled>
                    </div>
                    <div class="col-span-2">
