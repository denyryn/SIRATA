            ...
            <div class="pt-3 pb-10 text-black ps-12">
                <table>
                    <tr>
                        ...
                        <td class="py-2">:</td>
                        <td class="py-2">{{ $data_mahasiswa->nama_mahasiswa }}</td>
                    </tr>
                    <tr>
                        <td class="py-2">NIM</td>
                        <td class="py-2">:</td>
                        <td class="py-2">{{ $data_mahasiswa->nim }}</td>
                    </tr>
                    <tr>
                        <td class="py-2">Dosen Wali</td>
                        <td class="py-2">:</td>
                        <td class="py-2">{{ $data_mahasiswa->dosen->nama_dosen }}</td>
                    </tr>
                    <tr>
                        <td class="py-2">Program Studi &nbsp&nbsp&nbsp&nbsp</td>
                        <td class="py-2">: &nbsp&nbsp&nbsp&nbsp</td>
                        <td class="py-2">{{ $data_mahasiswa->program_studi->nama_prodi }}</td>
                    </tr>
                    <tr>
