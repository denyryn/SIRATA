                    ...
                    @foreach ($data_surat as $surat)
                        <tr>
                            ...
                            <td class="flex flex-row ">
                                ...
                                @if (Str::contains(strtolower($surat->status_terbaru), strtolower('Disetujui')))
                                    <a href="{{ route('admin.surat.download', $surat->id_surat) }}"
                                        class="p-2 px-4 ml-2 text-center text-white duration-150 bg-blue-600 rounded-lg btn hover:bg-blue-700">
