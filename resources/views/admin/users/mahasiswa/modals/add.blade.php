<!-- Main modal -->
<div id="add-mahasiswa-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="add-mahasiswa-modal">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" method="POST" action="{{ route('admin.manage_users.mahasiswa.create') }}">
                @csrf
                @method('POST')
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nim" id="nim"
                            ...
                            placeholder="Ketik NIM" required>
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nama_mahasiswa" id="nama_mahasiswa"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Ketik nama mahasiswa" required>
                    </div>
                    <div class="col-span-2">
