<!-- Main modal -->
<div id="add-dosen-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="add-dosen-modal">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" method="POST" action="{{ route('admin.manage_users.dosen.create') }}">
                @csrf
                @method('POST')
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nip" id="nip"
                            ...
                            placeholder="Ketik NIP" required>
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nidn" id="nidn"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Ketik NIDN" required>
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nama_dosen" id="nama_dosen"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Ketik nama dosen" required>
                    </div>
                    <div class="col-span-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="golongan" id="golongan"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Ketik nama golongan" required>
                    </div>
                </div>
                <button type="submit"
