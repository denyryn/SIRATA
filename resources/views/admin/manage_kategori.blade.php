            ...
            <tbody>
                ...
                @else
                    @foreach ($data_kategori as $kat)
                        <tr>
                            <td>{{ $kat->id_kategori_surat }}</td>
                            <td>{{ $kat->nama_kategori }}</td>
                            <form class="w-full" method="POST" action="{{ route('kategori.delete', $kat->id_kategori_surat) }}">
                                @csrf
                                @method('DELETE')
                                <td class="grid grid-cols-2">
                                    <a class="m-2 text-white bg-blue-600 btn no-animation hover:bg-blue-400"
                                        href="{{ route('kategori.edit', $kat->id_kategori_surat) }}">
                                        Edit
                                    </a>
