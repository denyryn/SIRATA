    ...
    <div class="h-full py-4 overflow-y-auto bg-blue-500 ">
        ...
        <div class="flex flex-col items-center my-5">
            <img src="{{ asset(Session::has('data_user') && Session::get('data_user')->foto_profil ? Session::get('data_user')->foto_profil : 'images/blank_profile.png') }}"
                class="m-3 rounded-full shrink-0 grow-0 size-14 sm:size-14" alt="User" title="cakepnyooo" />
            <div class="text-sm text-center text-white">
                <span class="block">
                    {{ Session::has('data_dosen') ? Session::get('data_dosen')->gelar_depan : '' }}
                    {{ Session::has('data_dosen') ? Session::get('data_dosen')->nama_dosen : 'Error' }}
                    {{ Session::has('data_dosen') ? Session::get('data_dosen')->gelar_belakang : '' }}
                </span>
                <span class="block">
                    {{ Session::has('data_dosen') ? Session::get('data_dosen')->nip : 'Unknown' }}
                </span>
            </div>
        </div>
        ...
        <ul class="space-y-2 font-medium text-white">
            {{-- DASHOBARD --}}
            <li>
                <a href="{{ route('dosen.index') }}" class="group">
            ...
            <li>
                {{-- LAYANAN SURAT --}}
                <a href="{{ route('dosen.surat.layanan') }}" class="">
                    <div class="flex items-center justify-start w-full p-2 py-3 hover:bg-blue-lighter px-7">
            ...
            <li>
                <a href="{{ route('dosen.profile') }}" class="group">
                    <div class="flex items-center justify-start w-full p-2 py-3 hover:bg-blue-lighter px-7">
