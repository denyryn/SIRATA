...
@section('content')
        ...
        <form id="surat_form" action="{{ route(Session::get('akses') . '.surat.form.store') }}" method="POST"
            ...
            <div class="mb-5">
                ...
                <div class="flex flex-row items-end w-full">
                    ...
                    <button class="hidden ml-1 text-xl text-white btn bg-blue-light hover:bg-blue-plain" type="button"
            ...
            <div class="mb-5">
                <label for="lower_body_part2" class="block mb-2 text-sm font-medium text-gray-900">
                    Lower Body 2
                </label>
                <textarea
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
    ...
    <script>
        function updateContent() {
            ...
            const pesertaElement = templateDocument.getElementById("pesertaContent");
            const lowerBodyPart1Element = templateDocument.getElementById("lowerBodyPart1Content");
            const lowerBodyPart2Element = templateDocument.getElementById("lowerBodyPart2Content");
            // ---
            ...
            const pesertaData = document.getElementById("peserta").value;

            const lowerBodyPart1Data = document.getElementById("lower_body_part1").value;
            const lowerBodyPart2Data = document.getElementById("lower_body_part2").value;
            ...
            pesertaElement.innerHTML = pesertaData;
            lowerBodyPart1Element.innerHTML = lowerBodyPart1Data;
            lowerBodyPart2Element.innerHTML = lowerBodyPart2Data;
