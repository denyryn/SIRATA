...
@section('form')
    <form id="surat_form" action="{{ route(Session::get('akses') . '.surat.form.store') }}" method="POST"
        ...
        <div class="mb-5">
            ...
            <input
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                id="nama_tujuan" name="nama_tujuan" type="text" placeholder="Masukkan Nama Tujuan"
                oninput="updateContent()" required value="{{ $data_perihal->nama_tujuan }}" />
        </div>
        ...
        <div class="mb-5">
            ...
            <input
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                id="alamat_tujuan" name="alamat_tujuan" type="text" placeholder="Masukkan Alamat Tujuan"
                oninput="updateContent()" required value="{{ $data_perihal->alamat_tujuan }}" />
        </div>
