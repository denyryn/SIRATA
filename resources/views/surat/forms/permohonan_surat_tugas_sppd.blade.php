...
@section('form')
    <form id="surat_form" action="{{ route(Session::get('akses') . '.surat.form.store') }}" method="POST"
        ...
        <div class="mb-5">
            ...
            <input type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                id="nama_tujuan" name="nama_tujuan" placeholder="Masukkan Nama Tujuan" required oninput="updateContent()"
        ...
        <div class="mb-5">
            ...
            <input type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                id="alamat_tujuan" name="alamat_tujuan" placeholder="Masukkan Alamat Tujuan" required
                oninput="updateContent()" value="{{ $data_perihal->alamat_tujuan }}" />
        </div>
        ...
        <div class="mb-5">
            ...
            <textarea
                ...
                onchange="updateContent()" required>
                </textarea>
        </div>
        ...
        <div class="mb-5">
            ...
            <textarea
                ...
                onchange="updateContent()">{{ old('lower_body', $data_perihal->lower_body) }}</textarea>
        </div>
